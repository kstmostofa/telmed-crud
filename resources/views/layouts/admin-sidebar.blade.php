        ...
        <ul id="side-menu" class="sidebar-menu">
            <li class="dropdown active"><a href="#"><i class="icon-home mr-1"></i> Dashboard</a>
                <ul>
                    ...
                    <li class="{{ request()->route()->getName() === 'admin.doctors.index'? 'active': '' }}">
                        <a href="{{ route('admin.doctors.index') }}"><i class="icon-rocket"></i> Doctor's</a>
                    </li>
                    <li class="{{ request()->route()->getName() === 'admin.agents.index'? 'active': '' }}">
                        <a href="{{ route('admin.agents.index') }}"><i class="icon-rocket"></i> Agent's</a>
                    </li>
                    <li class="">
                        <a href=""><i class="icon-rocket"></i> Patient's</a>
                    </li>
                </ul>
            </li>
