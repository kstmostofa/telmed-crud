    ...
    <div class="site-width">
        ...
        <ul id="side-menu" class="sidebar-menu">
            <li class="dropdown active"><a href="#"><i class="icon-home mr-1"></i> Dashboard</a>
                <ul>
                    <li class="{{ request()->route()->getName() === 'doctor.dashboard'? 'active': '' }}"><a
                            href="{{ route('doctor.dashboard') }}"><i class="icon-rocket"></i> Dashboard</a></li>
                    <li class="{{ request()->route()->getName() === 'doctor.appointment.index'? 'active': '' }}"><a
                            href="{{ route('doctor.appointment.index') }}"><i class="icon-rocket"></i>
                            Appointment's</a></li>
                </ul>
            </li>
