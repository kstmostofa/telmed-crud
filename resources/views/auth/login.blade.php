...
<body id="main-container" class="default">
    ...
    <div class="container">
        <div class="row vh-100 justify-content-between align-items-center">
            <div class="col-12">
                <form class="row row-eq-height lockscreen  mt-5 mb-5" method="POST" action="{{ route('login') }}">
                    @csrf
                    ...
                    <div class="login-form col-12 col-sm-7">
                        ...
                        <div class="mt-2">Don't have an account? <a href="{{ route('register') }}">Create an
                                Account</a>
                        </div>
                    </div>
                </form>
    ...
    <script src="/dist/js/toastr.script.js"></script>
    <!-- END: Template JS-->
    {!! Toastr::message() !!}
</body>
<!-- END: Body-->
