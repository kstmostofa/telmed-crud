@extends('layouts.app')
@section('title', 'Amar Doctor | Dashboard')
@section('content')
    <!-- START: Breadcrumbs-->
    <div class="row">
                                    ...
                                    <li class="outline-badge-success border-0 d-flex py-3 px-2 zoom">
                                        <label class="chkbox d-flex">
                                            ...
                                            <img src="dist/images/author2.jpg" alt="author" width="30"
                                                height="30" class="rounded-circle" />
                                            <span class="mb-0 ml-2 my-auto font-w-600">Aenean ligula porttitor consequat
                                                vitae eleifend enim.</span>
                                    ...
                                    <li class="outline-badge-warning border-0 d-flex py-3 px-2 zoom">
                                        <label class="chkbox d-flex">
                                            ...
                                            <img src="dist/images/author3.jpg" alt="author" width="30"
                                                height="30" class="rounded-circle" />
                                            <span class="mb-0 ml-2 my-auto font-w-600">In enim justo, rhoncus ut imperdiet
                                                a, venenatis vitae justo.</span>
